...
{
  cout << "CLOCK: " << Utils::Format(when, 3)  << "    NODE: " << Utils::Format(node_label_, 3) << "    FROM: " << Utils::Format(from_whom, 3) << endl;
...
string Node::ToString() const {
  ...
  s += " TIME: " + Utils::Format(time_got_message_, 8);
  s += " (FROM: " + Utils::Format(got_message_from_node_, 10) + ") ";
